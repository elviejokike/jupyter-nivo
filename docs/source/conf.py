...
# -*- coding: utf-8 -*-
#
# jupyter_nivo documentation build configuration file
#
...
_version_py = os.path.join(repo, 'jupyter_nivo', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyter_nivodoc'
...
latex_documents = [
    (master_doc, 'jupyter_nivo.tex', 'jupyter_nivo Documentation',
     'kike', 'manual'),
]
